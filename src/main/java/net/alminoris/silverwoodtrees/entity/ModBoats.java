package net.alminoris.silverwoodtrees.entity;
...
public class ModBoats
{
    ...
    {{
        for(String name : ModBlockSetsHelper.WOOD_NAMES)
            put(name, Identifier.of(SilverwoodTrees.MOD_ID, name+"_boat"));
    }};

    public static Dictionary<String, Identifier> chestBoatIDs = new Hashtable<>()
    {{
        for(String name : ModBlockSetsHelper.WOOD_NAMES)
            put(name, Identifier.of(SilverwoodTrees.MOD_ID, name+"_chest_boat"));
    }};
